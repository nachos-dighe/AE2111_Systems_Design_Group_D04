...
#inputs (line 2): x horizontal position of cg from the datum, b height shorter vertical profile, Ixx_required & Iyy_required are obtained from stress calculations
...
def Iyy(deltax,beta,alpha,x,z,b):
...
def thickness_selection(Ixx,Iyy,Ixx_required,Iyy_required):
