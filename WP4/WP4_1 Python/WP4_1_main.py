...
TMres_des=torsion(xlst_0, alpha_des, Llst_des, Dlst_des, ylst_0, CG_xList, CG_zList)
TMres_poscrit=torsion(xlst_0, alpha_des_positive, Llst_poscrit, Dlst_poscrit, ylst_0, CG_xList, CG_zList)
