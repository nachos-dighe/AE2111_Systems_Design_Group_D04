...
#plot margins
plt.subplot(2,1,1)
plt.plot(ylst,marg_f_pos)
plt.grid()
plt.margins(x=0)
plt.ylim(1,5)
plt.title("safety margin for positive loadcase in the front spar")
plt.ylabel("Safety margin")
plt.subplot(2,1,2)
plt.plot(ylst,marg_r_pos)
plt.grid()
plt.margins(x=0)
plt.ylim(1,5)
plt.title("safety margin for positive loadcase in the rear spar")
plt.ylabel("Safety margin")
plt.show()
#negative loadcase 
plt.subplot(2,1,1)
plt.plot(ylst,marg_f_neg)
plt.grid()
plt.margins(x=0)
plt.ylim(1,5)
plt.title("safety margin for negative loadcase in the front spar")
plt.ylabel("Safety margin")
plt.subplot(2,1,2)
plt.plot(ylst,marg_r_neg)
plt.grid()
plt.margins(x=0)
plt.ylim(1,8)
plt.title("safety margin for negative loadcase in the rear spar")
plt.ylabel("Safety margin")
plt.show()
...
##plt.legend(['Applied stress', 'Critical buckling stress'], loc='upper right')
##plt.show()
##
##plt.subplot(4,1,2)
